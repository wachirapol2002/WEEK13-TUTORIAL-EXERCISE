    ...
    <div class="columns is-centered">
        ...
        <div class="field">
            ...
            <template v-if="$v.username.$error">
                ...
                <p class="help is-danger" v-if="!$v.username.minLength">5-20 character</p>
                <p class="help is-danger" v-if="!$v.username.maxLength">5-20 character</p>
            </template>
        </div>
        ...
        <div class="field">
            ...
            <template v-if="$v.password.$error">
                ...
                <p class="help is-danger" v-if="!$v.password.complex">Must Have a-z,A-Z,0-9</p>
            </template>
        </div>
        ...
        <div class="field">
            ...
            <template v-if="$v.first_name.$error">
                ...
                <p class="help is-danger" v-if="!$v.first_name.maxLength">maxLength 150</p>
            </template>
        </div>
        ...
        <div class="field">
            ...
            <template v-if="$v.last_name.$error">
                ...
                <p class="help is-danger" v-if="!$v.last_name.maxLength">maxLength 150</p>
            </template>
        </div>
